...
/* globals vars */
extern t_binary                *binary;

/* flag options */
extern t_opcode                opcode_mode;	/*  -opcode 	                  */
extern t_stringmode            stringmode;     /*  -string                       */
extern t_stringmode            asm_mode;	/*  -asm 	                  */
extern t_opcode                importsc_mode;	/*  -importsc 	                  */
extern t_bind_mode             bind_mode;	/*  -bind & -port                 */
extern t_filter_mode           filter_mode;	/*  -filter 	                  */
extern t_filter_mode           only_mode;	/*  -only 	                  */
extern t_limitmode             limitmode;      /*  -limit                        */
extern t_mapmode               mapmode;        /*  -map                          */
extern e_syntaxcode            syntaxcode;     /*  -pysyn -csyn -phpsyn -perlsyn */
extern e_syntax                syntaxins;      /*  -intel -att                   */
extern char                    **target_argv;  /*  non-default target            */
